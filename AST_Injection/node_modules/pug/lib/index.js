...
function compileBody(str, options) {
  ...
  var ast = load.string(str, { // trong ast có lex, parse
  ...
  return {body: js, dependencies: dependencies}; // js từ đây được tạo ra
}
...
exports.compile = function(str, options) {
  ...
  str = String(str); // Đảm bảo tham số truyền vào là String
